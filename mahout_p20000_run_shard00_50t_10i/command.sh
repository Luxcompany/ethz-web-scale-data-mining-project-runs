...
MAHOUT="mahout"
#HDFS_IN="/cw-combined-pruned-20000/ClueWeb12_${NUM}.combined"
HDFS_IN="/runs/pru_20000_out/${NUM}"
HDFS_OUT="/runs/pru_20000_out_50t_10i/${NUM}"
OUT_DIR="/disk3/user_work/runs/mahout_p20000_run_shard00_50t_10i"
...
$MAHOUT cvb \
  ...
  -k 50 -nut 4 -x 10 -tf 0.1 -seed 23 \
