...
MAHOUT="mahout"
#HDFS_IN="/cw-combined-pruned-500/ClueWeb12_${NUM}.combined"
HDFS_IN="/runs/pru_500_out/${NUM}"
HDFS_OUT="/runs/pru_500_out_50t_15i/${NUM}"
OUT_DIR="/disk3/user_work/runs/mahout_p500_run_shard00_50t_15i"
...
#  -k 50 -nut 4 -x 15 -tf 0.1 -seed 23 \
