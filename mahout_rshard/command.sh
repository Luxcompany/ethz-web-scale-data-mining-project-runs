...
MAHOUT="mahout"
WORK_DIR="`pwd`/out"
HDFS_DIR="/runs/shard/${NUM}"
HDFS_DIR2="/runs/sout/${NUM}"
OUT_DIR="/disk3/user_work/runs/mahout_rshard/${NUM}"
...
$MAHOUT seq2sparse \
-i ${HDFS_DIR} \
-o ${HDFS_DIR2}/seqdir-sparse-lda -wt tf \
...
$MAHOUT rowid \
 -i ${HDFS_DIR2}/seqdir-sparse-lda/tf-vectors/ \
 -o ${HDFS_DIR2}/cas-out-matrix \
